...
//				double dCurrentRating = GetMatchQuality(m_oVectorField, oNormalTransMat, oPreparedCameraImg, m_oMapImg.size());
//
...
//		}
		...
		oForceVector *= (GetVectorLength(oOdomPosePosition - oOldOdomPosePosition) * 1.5  + dForceVecLen);
